...
@Repository
@Slf4j
public class HibernateTDRSO009ReportDao extends HibernateGenericDao<LocationMst> implements ITDRSO009Dao {
	
	@Override
	public List<LocationMst> getRangeLocation(TDRSO009Bean request) throws DataAccessException {
	...
	@Override
	public List<LocationMst> getMultiLocation(TDRSO009Bean request) throws DataAccessException {
		Session session = getSession();
