...
@Transactional
public interface ISapHandleTransactionTypeGoodsReplaceService {
	...
	DtSapCancelReserve callCancelReserveApi(DtSapCancelReserve dtSapCancelReserve);

	List<DtSapCancelReserve> cancelReserveGoodReplace(DtSapTransaction dtSapTransaction);
