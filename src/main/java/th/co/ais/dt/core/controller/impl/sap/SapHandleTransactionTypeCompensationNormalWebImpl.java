...
import th.co.ais.dt.core.service.core.interfaces.sap.ISapHandleTransactionTypeCompensationNormalService;
...
@Slf4j
@AllArgsConstructor
public class SapHandleTransactionTypeCompensationNormalWebImpl {

    private final ISapHandleTransactionTypeCompensationNormalService sapHandleTransactionTypeCompensationNormalService;

    @PostMapping(value = "/compensation-normal", produces = {"application/json"})
    public ResponseEntity<String> handleTransactionTypeCompensationNormal(@RequestBody DtSapTransaction request) {
        ...
        try {
             ...
             */
            DtSapTransaction dtSapTransaction = sapHandleTransactionTypeCompensationNormalService
                    .queryDtSapTransactionById(request.getSapTranId());

            /**
             * @STEP-1 Query workflow by transaction type
             */
            DtSapTransactionType dtSapTransactionType = sapHandleTransactionTypeCompensationNormalService
            ...
            if ("Y".equals(dtSapTransactionType.getPostTransaction())) {
                ...
                dtSapPostHeader = sapHandleTransactionTypeCompensationNormalService.queryInfoAndInsertPostTransaction(dtSapTransaction);
            }
            ...
            if (BeanUtil.isNotNull(dtSapPostHeader)) {
                DtSapPostHeader dtSapPostHeaderApi = sapHandleTransactionTypeCompensationNormalService.callPostTransactionApi(dtSapPostHeader);
                ...
                sapHandleTransactionTypeCompensationNormalService.updateDtSapPostHeader(dtSapPostHeader);
            }
            ...
            sapHandleTransactionTypeCompensationNormalService.updateDtSapTransactionAfterWorkflow(dtSapTransaction);

        } catch (Exception e) {
            log.error("handleTransactionTypeCompensationNormal error ", e);
        }
