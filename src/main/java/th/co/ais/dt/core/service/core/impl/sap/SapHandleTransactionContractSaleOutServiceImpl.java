...
@Slf4j
@AllArgsConstructor
public class SapHandleTransactionContractSaleOutServiceImpl implements ISapHandleTransactionContractSaleOutService{
...
//			docNo="T428924090000022";
			List<QueryContractAccrualBean> listAccrualReceipt = queryContactAccrualReceipt(sapContractTrans.getDocNo(),sapContractTrans.getCompany());
	...
	public DtSapUniversalHeader postUniversalReceipt(DtSapContractTrans sapContractTrans) throws DataAccessException {
		...
		try {
			...
			List<QueryContractUniversalBean> listContractUniversaPicking = queryContractUniversalReceipt(sapContractTrans.getCompany(), sapContractTrans.getDocNo());
	...
	public DtSapContractTransLog insertSapContractTransLog(DtSapContractTrans sapContractTrans) throws DataAccessException {
		...
		try {
			...
			List<QuerySapContractTransLogBean>  listQuerySapContractTransLog = queryDataSapContractTransLogReceipt(sapContractTrans.getDocNo(), sapContractTrans.getCompany());
...
//				dtSapContractTransLog.setImeiNumberNew(null);
	...
	private List<QueryContractAccrualBean> queryContactAccrualReceipt(String docNo,String company){
		try {
			//on cloud
//			return dtSapContractTypeDao.queryContactAccrualPingking(docNo,company);
			
			//on prem
			return queryContactAccrualReceiptOnPrem(docNo,company);
	...
	private List<QueryContractAccrualBean> queryContactAccrualReceiptOnPrem(String docNo,String company) {
		...
		String out = c.HttpClient(properties, dTConfig.getUrl().getDtws() + "/DTWS/api/saleout/v1/query-contract-accrual-receipt",gson.toJson(in) , "POST", null) ;
	...
	private List<QueryContractUniversalBean> queryContractUniversalReceipt(String company,String docNo){
		try {
			//on cloud
//			return dtSapContractTypeDao.queryContractUniversalReceipt(company,docNo);
			
			//on prem
			return queryContractUniversalReceiptOnPrem(company,docNo);
	...
	private List<QueryContractUniversalBean> queryContractUniversalReceiptOnPrem(String company,String docNo) {
		...
		String out = c.HttpClient(properties, dTConfig.getUrl().getDtws() + "/DTWS/api/saleout/v1/query-contract-universal-receipt",gson.toJson(in) , "POST", null) ;
		Gson gsonRes = new Gson();
		CommonResponseBean res = gsonRes.fromJson(out, CommonResponseBean.class);
		String resObject = gsonRes.toJson(res.getResultObj());
	...
	private List<QuerySapContractTransLogBean> queryDataSapContractTransLogReceipt(String docNo,String company) {
		//on cloud
//		return dtSapContractTransLogDao.queryDataSapContractTransLogReceipt(docNo, company);
		
		//on prem
		return queryDataSapContractTransLogReceiptOnPrem(docNo, company);
	}
	
	private List<QuerySapContractTransLogBean> queryDataSapContractTransLogReceiptOnPrem(String docNo,String company) {
		...
		String out = c.HttpClient(properties, dTConfig.getUrl().getDtws() + "/DTWS/api/saleout/v1/query-contract-log-receipt",gson.toJson(in) , "POST", null) ;
		Gson gsonRes = new Gson();
		CommonResponseBean res = gsonRes.fromJson(out, CommonResponseBean.class);
		String resObject = gsonRes.toJson(res.getResultObj());
